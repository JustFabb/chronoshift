    ...
    extend: {
      ...
      keyframes: {
        ...
        glitch: {
          ...
          '50%': { transform: 'translate(-2px, 5px)', filter: 'hue-rotate(90deg)' },
          '60%': { transform: 'translate(4px, -2px)', filter: 'hue-rotate(180deg)' },
          '70%': { transform: 'translate(-4px, 3px)', filter: 'hue-rotate(270deg)' },
          '80%': { transform: 'translate(2px, -4px)', filter: 'hue-rotate(360deg)' },
          '90%': { transform: 'translate(-3px, 4px)', filter: 'hue-rotate(90deg)' },
